          ...
          <div className="container mx-auto px-4 z-10">
            <div className="flex flex-col items-center">
              ...
              <div className="flex flex-col md:flex-row items-center gap-4">
                ...
                <NavLink to={"/about"}>
                  <Button variant="secondary"> Give me start on GitHub</Button>
                </NavLink>
              </div>
            </div>
          </div>
              ...
              <div className="bg-white/80 backdrop-blur-lg rounded-3xl p-6 shadow-xl">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 hover:bg-gray-100 rounded-xl transition-colors">
                    <div className="flex items-center gap-3">
                      <span className="text-xl">🟢</span>
                      <span className="font-medium text-gray-800">Node.js</span>
                    </div>
                    <span className="px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-700">
                      Expert
                    </span>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="mb-3 text-blue-600">
                          ...
                          elit. Odio corrupti, atque nam omnis eius blanditiis.
                        </p>
